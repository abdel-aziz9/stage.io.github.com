    ...
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            <a href="index.html" class="navbar-brand d-flex align-items-center text-center py-0 px-4 px-lg-5">
                <h1 class="m-0 text-primary">DREFOP-N</h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="fne.html" class="nav-item nav-link">FNE</a>
                    <div class="nav-item dropdown">
                        <a href="agrement.html" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">DREFOP</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="concours.html" class="dropdown-item"> AVIS CONCOURS</a>
                            <a href="agrement.html" class="dropdown-item">CENTRE AGREE</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">APROPOS</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="category.html" class="dropdown-item">FNE</a>
                            <a href="testimonial.html" class="dropdown-item">DREFOP</a>
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Apropos de drefop</h1>
